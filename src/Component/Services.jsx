  ...
  return (
    <div id='Services' className='w-full bg-gray-200 py-[10vh] group/pep relative'>
      ...
      <div className='flex w-full items-center justify-between group/pep whitespace-nowrap scroll-smooth relative overflow-x-scroll scrollbar-hide' id={'slider'}>
        {datas.map((data, id)=> 
        // each service
        <div className='hover:shadow-lg hover:scale-105 hover:bg-black/90 hover:text-white duration-150 ease-in shadow-black relative bg-white shadow-md m-3 p-4 flex flex-col justify-center items-center rounded-xl min-w-[300px] h-[200px]'>
          <p className='bg-gray-200 w-fit px-4 py-2 rounded-xl absolute top-2 left-3 text-black/90 text-xl font-bold'>{data.id}</p>
