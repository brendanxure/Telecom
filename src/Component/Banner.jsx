...
const Banner = () => {
  return (
    <div id='Home'className='' >
      <Helmet>
        <title>Telecom || Buy Data, Airtime to Cash, Bill Payments</title>
      </Helmet>
        <section className='container-fluid w-100 p-0 position-relative'>
            ...
            <h1 className='animate__animated animate__backInLeft animate__delay-1s animate__infinite animate__slow fs-1' style={{color: "white"}}>Welcome to<span className='mx-2' style={{color: "#1171ef"}}> TELECOM!</span></h1>
