                ...
                <div className="table-responsive">
                  <table className="table">
                    ...
                    <tbody>
                      <tr>
                        <td>
                          <img src="" className="mr-2" alt="face" /> David Grey </td>
                      ...
                      <tr>
                        <td>
                          <img src="" className="mr-2" alt="face" /> Stella Johnson </td>
                      ...
                      <tr>
                        <td>
                          <img src="" className="mr-2" alt="face" /> Marina Michel </td>
                      ...
                      <tr>
                        <td>
                          <img src="" className="mr-2" alt="face" /> John Doe </td>
              ...
              <div className="card-body">
                ...
                <div className="row mt-3">
                  <div className="col-6 pr-1">
                    <img src="" className="mb-2 mw-100 w-100 rounded" alt="face" />
                    <img src="" className="mw-100 w-100 rounded" alt="face" />
                  </div>
                ...
                <div className="d-flex mt-5 align-items-start">
                  <img src="" className="img-sm rounded-circle mr-3" alt="face" />
