    ...
    <div className='flex flex-col flex-wrap lg:flex-row lg:flex-nowrap'>
      {/* left-side */}
        <div className='basis-1/2 flex flex-col justify-center px-4 text-gray-700 py-10'>
            ...
            <p className='my-8'>Join our network of exceptional entrepreneurs who partner with TELECOM and help us expand our 'easy-payments' experience to your network. As a Referrer, you will earn a commission for every transaction you perform for your customers and be part of our effort to promote technology and empower students on campuses of higher learning and youths in diaspora.</p>
            <p className=''>Our referral program offers outstanding incentives to encourage entrepreneurial and managerial skill acquisition, enhance growth and development, and promote empowerment. By becoming a Referrer, you will have the opportunity to leverage your network and earn extra income while contributing to the advancement of technology in our society.</p>
            <p className='my-8'>Join our team today and help us bring the benefits of TELECOM's 'easy-payments' experience to more people!</p>
            <a className='w-[150px] text-center bg-blue-500 px-4 py-2' href="">Get Started</a>
        </div>
